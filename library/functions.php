...
function buildVehiclesDisplay($vehicles){
    ...
    foreach ($vehicles as $vehicle) {
        $dv .= '<li>';
        $dv .= "<div><a href='/phpmotors/vehicles/?action=vehicle_detail&invId=".urlencode($vehicle['invId'])."'><img src='$vehicle[imgPath]' alt='Image of $vehicle[invMake] $vehicle[invModel] on phpmotors.com'></a></div>";
        $dv .= '<hr>';
...
function buildOtherImagesList($images){
    $el = "<ul class='otherImagesList'>";
    
    foreach($images as $image){
        $el .= "<li><img src='". $image['imgPath'] ."' alt='". $image['imgName'] ."'></li>";
    }
