    ...
    <div class="content">
        ...
        <main>
            ...
            <form action="/phpmotors/reviews/index.php" method="POST">
                ...
                <label for="reviewText" style="display:block; font-size:large">Comment:</label>
                <textarea name="reviewText" id="reviewText" cols="30" rows="10" readonly><?php echo $reviewInfo[0]['reviewText'] ?></textarea>
